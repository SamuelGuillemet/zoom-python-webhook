...
class CheckedInWebHook(BaseWebhookEvent):
...
class ResponseWebhookCheckedIn(BaseResponseWebhookEvent):
    """This is the schema for the response for zoomroom.checked_in webhook.
